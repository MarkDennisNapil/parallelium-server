...
exports.Search = (req, res) => {
  ...
  Promise.all([
    userModel.find({ $search: { $text: keyword, path: { wildcard: "*"} } }),
    postModel.find({ $search: { $text: keyword, path: { wildcard: "*"} } }),
    textModel.find({ $search: { $text: keyword, path: { wildcard: "*"} } }),
    videoModel.find({ $search: { $text: keyword, path: { wildcard: "*"} } }),
    vibeModel.find({ $search: { $text: keyword, path: { wildcard: "*"} } })
  ]).then(data => {
